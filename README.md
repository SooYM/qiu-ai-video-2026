...
• Cyberpunk Grid & Particle Background: An interactive HTML5 <canvas> rendering real-time, dynamic node connections with custom physics, responding fluidly to viewport scale modifications.
...
• Typography: Apple Design Ecosystem sans-serif hierarchy based on the Inter font superfamily.
